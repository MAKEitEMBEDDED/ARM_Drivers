...
/*****************************************************************************************
* The Following GPIO Driver contains 6 offsets:
*		1)	Data Register.
*		2)	Data Direction.
*		3)	Enable Digital.
*		4)	Pull-Up Resistor.
...
*		6)	Clock Enable.
*
* In order to set a pin as Output, Follow the following instructions:
* 1)	Enable the Clock on the port, in order to use the port registers.
* 2)	Set the direction of the port (Input | Output).
* 3)	Enable the Digital I/O feature of port.
* 4)	Assign a value to port using Data Register
*****************************************************************************************/
...
#define DDRPORT_F (*((volatile u32*)(0x40025400)))
